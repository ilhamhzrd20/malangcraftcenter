  ...
  <Container>
    ...
    >
      <Content>
        ...
        <NameTextWrapper>
          <NameText>Ilham dan Fadli</NameText>
        </NameTextWrapper>
        <SubTextWrapper>
          <SubText>D4 Teknik Informatika PENS</SubText>
        </SubTextWrapper>
        ...
        <AboutMeWrapper>
          ...
          <AboutMeDescription>
            {
              "Kami adalah mahasiswa semester 6 D4 Teknik Informatika Politeknik Elektronika Negeri Surabaya.\n\nKami tinggal di Keputih Makam Gang 3B Nomor 82 Surabaya"
            }
          </AboutMeDescription>
        </AboutMeWrapper>
      </Content>
