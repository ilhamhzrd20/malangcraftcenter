...
const RootStack = createStackNavigator(
  {
    ...
    [ROUTE_NAMES.SEE_ALL_EVENTS]: {
      screen: AllEvents,
      navigationOptions: ({ navigation }) => setDefaultHeaderLayout(navigation, 'Expo Kerajinan'),
    },

    [ROUTE_NAMES.YOU_MIGHT_LIKE_SEE_ALL]: {
      screen: YouMightLikeSeeAll,
      navigationOptions: ({ navigation }) => setDefaultHeaderLayout(navigation, 'Rekomendasi Produk'),
    },

    [ROUTE_NAMES.POPULAR_SEE_ALL]: {
      screen: PopularSeeAll,
      navigationOptions: ({ navigation }) => setDefaultHeaderLayout(navigation, 'Sedang Populer'),
    },
